...
parser.add_argument('--name', metavar='NAME', default='test_model',
                    help='job name')
...
parser.add_argument("--soft-epochs", default=100, type=int)
parser.add_argument("--soft-alpha", default=1.0, type=float)
parser.add_argument("--lable-margine", default=0.5, type=float)
parser.add_argument('--soft-loss', action='store_true', default=False,
                    help='soft_loss or mse loss')

parser.add_argument('--model_selection', default=114, type=int)       # 14, 23, 72, 112, 285, 470, 600
...
def main():
    ...
    validate(0, model_ema.ema, loader_eval, validate_loss_fn, args, log_suffix=' (EMA)',
