...
from supernet_backbone.lib_back.models.utils import *
from supernet_backbone.lib_back.models.units import *
from supernet_backbone.lib_back.models.utils import _parse_ksize
        ...
        for stage_idx, stage_block_args in enumerate(model_block_args):
            ...
            for block_idx, block_args in enumerate(stage_block_args):
                ...
                if self.choice_num == 1:
                    ...
                    if self.resunit:
                        from lib.models.resunit import get_Bottleneck
